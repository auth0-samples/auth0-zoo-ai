# Zoo Management Platform (Llama Index Version)

A demonstration project that integrates **LlamaIndex** and **FastAPI** to control authenticated internal APIs using GenAI tool calling. The project simulates a zoo management platform that can be partially operated through natural language prompts interpreted by an AI agent.
